...
export function similarPairs(index, { threshold = 0.82, maxPairs = 25 } = {}) {
  ...
  const pairs = [...bestByNotePair.values()]
    ...
    .map((p) => ({
      ...
      a: { note: p.a.noteRel, heading: p.a.heading, snippet: short(p.a.text), text: p.a.text.slice(0, 900) },
      b: { note: p.b.noteRel, heading: p.b.heading, snippet: short(p.b.text), text: p.b.text.slice(0, 900) },
    }));
